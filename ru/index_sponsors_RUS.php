...
<html>
	...
	<body>	
		<div class="page">
			<?php 
			$links = 'index_sponsors_US.php';
			include ('header_RUS.php'); ?>
			<div class="bodyBox">
				<div class="bodyElement__sponsors">
					<div class="bodyContent ">
						<div class="sponsors__title color">Организаторы и спонсоры</div>
						...
						<table class="orgTable border">
						  <tr class="">
							<td class="border logo1"><a href="http://humus.ru/ihss/"><img class="logo" src="images/logoIHSSCIS.svg" align="left"></a><div class="textlogo1">Региональное Отделение СНГ <br>Международного гуминового общества</div></td>
