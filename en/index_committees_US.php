...
<html>
	...
	<style>
    body{
         background: url(images/fonGrad.svg) no-repeat;
	...
	<body>
		<div class="page">
			<?php 
			$links = 'index_committees_RUS.php';
			...
			<div class="bodyBox">
				<div class="bodyElement">
					...
					<div class="tittle">International Program Committee</div>
							...
							<div><span class="thumbnailBlack">Boris M. Kogut</span> – Dr. habil., Dokuchaev Soil Science Institute of RAS, Moscow, Russia<br><br></div>

							<div><span class="thumbnailBlack">Nadezhda S. Kudryasheva</span> – Professor, Institute of Biophysics, Siberian Branch of RAS, Krasnoyarsk, Russia<br><br></div>
